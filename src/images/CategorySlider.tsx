			...
			<div className='carousel-inner'>
				...
				<div className='carousel-item'>
					...
					<div className='carousel-caption d-none d-md-block'>
						...
						<p>
							...
							books with our editors. Some real gems are hidden in our library.
							<a
								href='https://manybooks.net/subscribe'
								style={{ color: '#95f0df' }}>
								Read more
							</a>
							.
				...
				<div className='carousel-item'>
					...
					<div className='carousel-caption d-none d-md-block'>
						...
						<p>
							Join 150,000+ fellow readers. Get free and discounted bestsellers
							straight to your inbox with the ManyBooks eBook deals newsletter.
							<a
								href='https://manybooks.net/subscribe'
								style={{ color: '#95f0df' }}>
								Signup now
